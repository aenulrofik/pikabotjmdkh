...
async def start(_, message):
    if len(message.command) > 1:
        ...
        start_string = 'Hi, Pik4bot is here 🐱\n' \
                    ...
                    'PM to the <b><a href="https://t.me/XRofikX">"<b>Owner</b>"</a> if you want to use this bot in private massage, or you can join <b><a href="https://t.me/+67WpWvq1-RBhYjNl">"<b>This Group</b>"</a></b> to start use this bot without permission'
